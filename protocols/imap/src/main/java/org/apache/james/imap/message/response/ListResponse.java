...
public final class ListResponse extends AbstractListingResponse implements ImapResponseMessage {
    ...
    public ListResponse(final boolean noInferiors, final boolean noSelect, final boolean marked, final boolean unmarked, boolean hasChildren, boolean hasNoChildren, final UnresolvedMailboxName name, final char delimiter) {
