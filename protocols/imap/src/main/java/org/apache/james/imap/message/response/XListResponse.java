...
public class XListResponse extends AbstractListingResponse implements ImapResponseMessage {
    ...
    public XListResponse(final boolean noInferiors, final boolean noSelect, final boolean marked, final boolean unmarked, boolean hasChildren, boolean hasNoChildren, final UnresolvedMailboxName name, final char delimiter, final MailboxType type) {
